 ...
 * Slug: bjork/general-follow-us-horizontal
 * Categories: bjork-general
 */
?>
<!-- wp:group {"align":"wide","style":{"border":{"radius":"8px"}},"backgroundColor":"primary","textColor":"background","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
